...
script_version = '1'
window_title = f"WARP-PLUS-GB ++ By Pyay Oak Soe (version {script_version})"
import urllib.request
import json
import datetime
import random
...
print('  By Pyay Oak Soe(hjk) \n')

print("[-] you can getting unlimited GB on Warp+.")
print(f"[-] Version: {script_version}")
print("--------")
print("[+] THIS SCRIPT CODDED BY Pyay")
print("[-] modified by Pyay Oak Soe")
print("--------")
referrer = input("[#] Enter the WARP+ ID:b15e2bf9-d2fb-4588-8308-98eb67f04b8d")
...
print("[-] modified by Pyay Oak Soe")
print("--------")
referrer = input("[#] Enter the WARP+ ID:52396523-2002-4ba7-bb58-184fcdd2612d")
def progressBar():
  animation = [
      "[□□□□□□□□□□]", "[■□□□□□□□□□]", "[■■□□□□□□□□]", "[■■■□□□□□□□]",
      "[■■■■□□□□□□]", "[■■■■■□□□□□]", "[■■■■■■□□□□]", "[■■■■■■■□□□]",
